        ...
        <div className="financing-body">
          ...
          <div className="financing-item">
            <div className="financing-basic-info">
              <div>
                <input type="checkbox"/>
                <span className="financing-component-title">Basic Info</span>
                <input type="checkbox"/>
              </div>
            ...
            <div className="financing-energy-info">
              <span className="financing-component-title">Energy Info</span>
              <input type="checkbox"/>
              <div>
              <br/>
            ...
            <div className="financing-energy-info">
              <span className="financing-component-title">Project Info</span>
              <input type="checkbox"/>
              ...
              <div className="financing-energy-info">
                <span className="financing-component-title">Uploaded Documents</span>
                <input type="checkbox"/>
              ...
              <div className="financing-energy-info">
                <input type="checkbox"/>
                <span className="financing-component-title">Preferred Communication Method</span>
                <input type="checkbox"/>
                <br/>
                <br/>
                <div>
          ...
          <div class="financing-item">
            <div className="financing-home-info">
              <input type="checkbox"/>
              <span className="financing-component-title">Home Info</span>
              <input type="checkbox"/>
              <div className="financing-project-info-space">
            ...
            <div className="financing-energy-info">
              <span className="financing-component-title">Financial Info</span>
              <input type="checkbox"/>
              <br/>
              <br/>
            ...
            <div className="financing-sales-notes">
              <h2 className="financing-component-title">Account Management Notes Notes</h2>
              <textarea rows="5" cols="50"
                name="salesNotes" onChange={this.handleChange}>
              </textarea>
            </div>
